...
export const initialUsers = [
  ...
  },
  {
    ...
    email: 'worker07@demo.coop',
    mobile: '9876510007',
    role: ROLES.WORKER,
    password: 'password123',
    workerId: 'WORKER-DEMO-007',
    createdAt: '2025-01-12T00:00:00.000Z'
  },
  {
    id: 'USR-WRK-008',
    name: 'Worker Demo 08 (Gardener)',
    email: 'worker08@demo.coop',
    mobile: '9876510008',
    role: ROLES.WORKER,
    password: 'password123',
    workerId: 'WORKER-DEMO-008',
    createdAt: '2025-01-12T00:00:00.000Z'
  },
  {
    id: 'USR-WRK-009',
    name: 'Worker Demo 09 (Caregiver)',
    email: 'worker09@demo.coop',
    mobile: '9876510009',
    role: ROLES.WORKER,
    password: 'password123',
...
export const initialWelfareRecords = [
  ...
  },
  {
    id: 'WELFARE-DEMO-007',
    workerId: 'WORKER-DEMO-007',
    workerName: 'Worker Demo 07 (Carpenter)',
    societyId: 'SOC-DEMO-001',
    welfareSchemeName: 'Demo Cooperative Worker Welfare Program',
    insurancePolicyNumber: 'INS-DEMO-007',
    insuranceStatus: 'Active',
    coverageAmount: 200000,
    accidentalCoverage: 300000,
    benefits: ['Accidental Protection', 'Annual Health Checkup'],
    totalContributionsContributed: 350,
    claimsProcessedCount: 0,
    eligibilityStatus: 'Eligible & Enrolled',
    status: 'Active (Demo Record)'
  },
  {
    id: 'WELFARE-DEMO-008',
    workerId: 'WORKER-DEMO-008',
    workerName: 'Worker Demo 08 (Gardener)',
    societyId: 'SOC-DEMO-002',
    welfareSchemeName: 'Demo Cooperative Worker Welfare Program',
    insurancePolicyNumber: 'INS-DEMO-008',
    insuranceStatus: 'Active',
    coverageAmount: 200000,
    accidentalCoverage: 300000,
    benefits: ['Health Screening Support', 'Emergency Distress Fund'],
    totalContributionsContributed: 280,
    claimsProcessedCount: 0,
    eligibilityStatus: 'Eligible & Enrolled',
    status: 'Active (Demo Record)'
  },
  {
    ...
    societyId: 'SOC-DEMO-002',
    welfareSchemeName: 'Demo Cooperative Worker Welfare Program',
    insurancePolicyNumber: 'INS-DEMO-009',
    insuranceStatus: 'Active',
    coverageAmount: 250000,
    accidentalCoverage: 350000,
    benefits: ['Medical Shield', 'Annual Health Screening Support', 'Caregiver Aid'],
    totalContributionsContributed: 520,
    claimsProcessedCount: 0,
    eligibilityStatus: 'Eligible & Enrolled',
    status: 'Active (Demo Record)'
  },
  {
    id: 'WELFARE-DEMO-010',
    workerId: 'WORKER-DEMO-010',
    workerName: 'Ritu Sharma (Househelp Specialist)',
    societyId: 'SOC-DEMO-001',
    welfareSchemeName: 'Demo Cooperative Worker Welfare Program',
    insurancePolicyNumber: 'INS-DEMO-010',
    insuranceStatus: 'Active',
    coverageAmount: 200000,
    accidentalCoverage: 300000,
    benefits: ['Annual Health Screening Support', 'Safety Kit Allowance', 'Family Health Fund'],
    totalContributionsContributed: 490,
    claimsProcessedCount: 0,
    eligibilityStatus: 'Eligible & Enrolled',
    status: 'Active (Demo Record)'
  },
  {
    id: 'WELFARE-DEMO-011',
    workerId: 'WORKER-DEMO-011',
    workerName: 'Priya Verma (Househelp)',
    societyId: 'SOC-DEMO-001',
    welfareSchemeName: 'Demo Cooperative Worker Welfare Program',
    insurancePolicyNumber: 'INS-DEMO-011',
    insuranceStatus: 'Active',
    coverageAmount: 200000,
    accidentalCoverage: 300000,
    benefits: ['Annual Health Screening Support', 'Emergency Distress Fund'],
    totalContributionsContributed: 380,
    claimsProcessedCount: 0,
    eligibilityStatus: 'Eligible & Enrolled',
    status: 'Active (Demo Record)'
  },
  {
    id: 'WELFARE-DEMO-012',
    workerId: 'WORKER-DEMO-012',
    workerName: 'Anita Kumari (Beauty Expert)',
    societyId: 'SOC-DEMO-001',
    welfareSchemeName: 'Demo Cooperative Worker Welfare Program',
    insurancePolicyNumber: 'INS-DEMO-012',
    insuranceStatus: 'Active',
    coverageAmount: 200000,
    accidentalCoverage: 300000,
    benefits: ['Health Screening Support', 'Hygiene Kit Subsidy'],
    totalContributionsContributed: 450,
    claimsProcessedCount: 0,
    eligibilityStatus: 'Eligible & Enrolled',
    status: 'Active (Demo Record)'
  },
  {
    id: 'WELFARE-DEMO-013',
    workerId: 'WORKER-DEMO-013',
    workerName: 'Sunita Devi (Spa Therapist)',
    societyId: 'SOC-DEMO-002',
    welfareSchemeName: 'Demo Cooperative Worker Welfare Program',
    insurancePolicyNumber: 'INS-DEMO-013',
    insuranceStatus: 'Active',
    coverageAmount: 200000,
    accidentalCoverage: 300000,
    benefits: ['Health Screening Support', 'Wellness & Safety Grant'],
    totalContributionsContributed: 560,
    claimsProcessedCount: 0,
    eligibilityStatus: 'Eligible & Enrolled',
    status: 'Active (Demo Record)'
  },
  {
    id: 'WELFARE-DEMO-014',
    workerId: 'WORKER-DEMO-014',
    workerName: 'Kavita Joshi (Nail Artist)',
    societyId: 'SOC-DEMO-001',
    welfareSchemeName: 'Demo Cooperative Worker Welfare Program',
    insurancePolicyNumber: 'INS-DEMO-014',
    insuranceStatus: 'Active',
    coverageAmount: 200000,
    accidentalCoverage: 300000,
    benefits: ['Health Screening Support', 'Ergonomic Tool Subsidy'],
    totalContributionsContributed: 310,
    claimsProcessedCount: 0,
    eligibilityStatus: 'Eligible & Enrolled',
    status: 'Active (Demo Record)'
  },
  {
    id: 'WELFARE-DEMO-015',
    workerId: 'WORKER-DEMO-015',
    workerName: 'Deepa Nair (Househelp)',
    societyId: 'SOC-DEMO-002',
    welfareSchemeName: 'Demo Cooperative Worker Welfare Program',
    insurancePolicyNumber: 'INS-DEMO-015',
    insuranceStatus: 'Active',
    coverageAmount: 200000,
    accidentalCoverage: 300000,
    benefits: ['Annual Health Screening Support', 'Emergency Distress Fund'],
    totalContributionsContributed: 240,
    claimsProcessedCount: 0,
    eligibilityStatus: 'Eligible & Enrolled',
    status: 'Active (Demo Record)'
  }
